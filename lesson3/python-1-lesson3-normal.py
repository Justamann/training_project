...
name_staff = ['Vasya', 'Petya', 'Dima', 'Olga']
salary = [150000, 600000, 30000, 130000]

TAX_PERCENT = 13
MAX_SALARY = 500000

staff_salary = dict(zip(name_staff, salary))
...
with open('salary.txt', 'r', encoding='UTF-8') as f:
    for line in f:
        ...
        print('Salary {} after tax is {}'.format(name.upper(), after_tax))
